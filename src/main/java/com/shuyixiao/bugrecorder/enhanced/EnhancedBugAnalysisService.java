 ...
 */
@Service
public final class EnhancedBugAnalysisService {

    private static final Logger LOG = Logger.getInstance(EnhancedBugAnalysisService.class);
    ...
    public EnhancedBugAnalysisService(@NotNull Project project) {
        ...
        this.analysisExecutor = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    ...
                    public Thread newThread(@NotNull Runnable r) {
                        ...
                        t.setName("BugAnalysis-Enhanced-" + t.getName());
                        t.setDaemon(true);
                        return t;
                    }
                },
        ...
        LOG.info("Enhanced Bug Analysis Service initialized for project: " + project.getName());
    }
    ...
    public void shutdown() {
        LOG.info("Shutting down Enhanced Bug Analysis Service for project: " + project.getName());
        ...
        LOG.info("Enhanced Bug Analysis Service shutdown completed for project: " + project.getName());
    }
