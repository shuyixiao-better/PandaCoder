 ...
 */
@Service
public final class EnhancedBugRecordManager {

    private static final Logger LOG = Logger.getInstance(EnhancedBugRecordManager.class);
    ...
    public EnhancedBugRecordManager(@NotNull Project project) {
        ...
        this.recordExecutor = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    ...
                    public Thread newThread(@NotNull Runnable r) {
                        ...
                        t.setName("BugRecord-Manager-" + t.getName());
                        t.setDaemon(true);
                        return t;
                    }
                },
        ...
        this.cleanupExecutor = Executors.newSingleThreadScheduledExecutor(r -> {
            Thread t = new Thread(r, "BugRecord-Cleanup");
            t.setDaemon(true);
            return t;
        });
        ...
        LOG.info("Enhanced Bug Record Manager initialized for project: " + project.getName());
    }
     ...
     * 创建并保存测试记录
     */
    public void createAndSaveTestRecord(@NotNull String project, @NotNull ErrorType errorType, 
    ...
    public void shutdown() {
        LOG.info("Shutting down Enhanced Bug Record Manager for project: " + project.getName());
        ...
        LOG.info("Enhanced Bug Record Manager shutdown completed for project: " + project.getName());
    }
